...
/** InlineDebugSettings
 * @typedef {object} InlineDebugSettings An example template for custom nodes
 *
 * @property {string} name Descriptive name, only used by Editor
 * @property {boolean} active Is debug output active? If not, passthrough only
 * @property {boolean=} allowOverride Whether msg._debug can override the node settings (optional)
 */

/** InlineDebugNode
 * @typedef {object} InlineDebugNode An example template for custom nodes
 *
 * @property {InlineDebugSettings} settings Shared debug configuration settings
 * @property {string} name Descriptive name, only used by Editor
 * @property {boolean} active Is debug output active? If not, passthrough only
